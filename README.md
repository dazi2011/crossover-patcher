...
本项目与库洛游戏、腾讯、CodeWeavers、Apple 及任何反作弊供应商均无关联，也未获得其认可、赞助或支持。CrossOver、Wine、Wuthering Waves、鸣潮、D3DMetal 及其他名称和商标归各自权利人所有。本项目分发的crossover本体没有进行过任何破解、绕过或任何有可能规避许可证的修改。对于二次分发，CodeWeavers官方可以随时通过issus联系我下架此仓库或二次分发文件。
